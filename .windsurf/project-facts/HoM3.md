...
> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/HoM3.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py HoM3`
...
- **Beschreibung**: Hom 
- **GitHub**: `achimdehnert/HoM3` → https://github.com/achimdehnert/HoM3
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/HoM3` |
| Python | `/home/devuser/github/HoM3/.venv/bin/python` |
