...
> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/LUKAS.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py LUKAS`
...
- **Beschreibung**: –
- **GitHub**: `achimdehnert/LUKAS` → https://github.com/achimdehnert/LUKAS
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/LUKAS` |
| Python | `/home/devuser/github/LUKAS/.venv/bin/python` |
