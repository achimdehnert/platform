# Project Facts: Lukas_Fasttrack

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/Lukas_Fasttrack.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py Lukas_Fasttrack`

---

## Projekt

- **Beschreibung**: Lukas Fasttrack
- **GitHub**: `achimdehnert/Lukas_Fasttrack` → https://github.com/achimdehnert/Lukas_Fasttrack
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/Lukas_Fasttrack` |
| Python | `/home/devuser/github/Lukas_Fasttrack/.venv/bin/python` |
