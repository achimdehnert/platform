# Project Facts: Lukas__FT_actual

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/Lukas__FT_actual.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py Lukas__FT_actual`
...
- **Beschreibung**: –
- **GitHub**: `achimdehnert/Lukas__FT_actual` → https://github.com/achimdehnert/Lukas__FT_actual
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/Lukas__FT_actual` |
| Python | `/home/devuser/github/Lukas__FT_actual/.venv/bin/python` |
