# Project Facts: agent-zero

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/agent-zero.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py agent-zero`

---

## Projekt

- **Beschreibung**: Agent Zero AI framework
- **GitHub**: `achimdehnert/agent-zero` → https://github.com/achimdehnert/agent-zero
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/agent-zero` |
| Python | `/home/devuser/github/agent-zero/.venv/bin/python` |
