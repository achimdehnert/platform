# Project Facts: ausschreibungs-hub

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/ausschreibungs-hub.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py ausschreibungs-hub`
...
| **Pfad** | `/opt/ausschreibungs-hub` |
| **Port** | `8101` |
| **Container** | `ausschreibungs_hub_web` |
| **Migrate** | `python manage.py migrate --noinput` |
| **Compose** | `docker-compose.prod.yml` |
| **Image** | `ghcr.io/achimdehnert/ausschreibungs-hub-web:${IMAGE_TAG:-latest}` |
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/ausschreibungs-hub` |
| Venv | `/home/devuser/github/ausschreibungs-hub/.venv/bin/python` |
| DB (lokal) | `localhost:5432/ausschreibungs_hub` |
