# Project Facts: coach-hub

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/coach-hub.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py coach-hub`
...
| **Pfad** | `/opt/coach-hub` |
| **Port** | `8007` |
| **Container** | `coach_hub_web` |
| **Migrate** | `python manage.py migrate --noinput` |
| **Compose** | `docker-compose.prod.yml` |
| **Image** | `ghcr.io/achimdehnert/coach-hub-web:${IMAGE_TAG:-latest}` |
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/coach-hub` |
| Venv | `/home/devuser/github/coach-hub/.venv/bin/python` |
| DB (lokal) | `localhost:5432/coach_hub` |
