# Project Facts: homelizard

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/homelizard.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py homelizard`
...
- **Beschreibung**: –
- **GitHub**: `achimdehnert/homelizard` → https://github.com/achimdehnert/homelizard
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/homelizard` |
| Python | `/home/devuser/github/homelizard/.venv/bin/python` |
