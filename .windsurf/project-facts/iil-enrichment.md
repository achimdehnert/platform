...
> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/iil-enrichment.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py iil-enrichment`
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/iil-enrichment` |
| Python | `/home/devuser/github/iil-enrichment/.venv/bin/python` |
