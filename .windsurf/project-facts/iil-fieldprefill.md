# Project Facts: iil-fieldprefill

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/iil-fieldprefill.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py iil-fieldprefill`
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/iil-fieldprefill` |
| Python | `/home/devuser/github/iil-fieldprefill/.venv/bin/python` |
