# Project Facts: iil-testkit

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/iil-testkit.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py iil-testkit`

---

## Projekt

- **Beschreibung**: Shared test factory package for IIL Platform Django repos — fixtures, assertions, smoke testing, ADR enforcement
- **GitHub**: `achimdehnert/iil-testkit` → https://github.com/achimdehnert/iil-testkit
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/iil-testkit` |
| Python | `/home/devuser/github/iil-testkit/.venv/bin/python` |
