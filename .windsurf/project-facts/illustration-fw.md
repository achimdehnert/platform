# Project Facts: illustration-fw

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/illustration-fw.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py illustration-fw`
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/illustration-fw` |
| Python | `/home/devuser/github/illustration-fw/.venv/bin/python` |
