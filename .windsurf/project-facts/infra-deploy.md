# Project Facts: infra-deploy

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/infra-deploy.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py infra-deploy`
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/infra-deploy` |
| Python | `/home/devuser/github/infra-deploy/.venv/bin/python` |
