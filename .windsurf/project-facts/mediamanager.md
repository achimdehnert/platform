# Project Facts: mediamanager

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/mediamanager.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py mediamanager`
...
- **Beschreibung**: –
- **GitHub**: `achimdehnert/mediamanager` → https://github.com/achimdehnert/mediamanager
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/mediamanager` |
| Python | `/home/devuser/github/mediamanager/.venv/bin/python` |
