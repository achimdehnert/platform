# Project Facts: nl2cad

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/nl2cad.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py nl2cad`
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/nl2cad` |
| Python | `/home/devuser/github/nl2cad/.venv/bin/python` |
