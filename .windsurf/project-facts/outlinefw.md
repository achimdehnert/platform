# Project Facts: outlinefw

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/outlinefw.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py outlinefw`
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/outlinefw` |
| Python | `/home/devuser/github/outlinefw/.venv/bin/python` |
