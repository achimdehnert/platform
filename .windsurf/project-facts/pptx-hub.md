# Project Facts: pptx-hub

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/pptx-hub.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py pptx-hub`
...
| **Image** | `ghcr.io/achimdehnert/pptx-hub-web:${IMAGE_TAG:-latest}` |
