# Project Facts: repomgr

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/repomgr.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py repomgr`

---

## Projekt

- **Beschreibung**: GitHub Repository Management Tool
- **GitHub**: `achimdehnert/repomgr` → https://github.com/achimdehnert/repomgr
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/repomgr` |
| Python | `/home/devuser/github/repomgr/.venv/bin/python` |
