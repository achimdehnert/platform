...
> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/research-hub.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py research-hub`
...
| **Pfad** | `/opt/research-hub` |
| **Port** | `8098` |
| **Container** | `research_hub_web` |
| **Migrate** | `python manage.py migrate --noinput` |
| **Compose** | `docker-compose.prod.yml` |
| **Image** | `ghcr.io/achimdehnert/research-hub-web:${IMAGE_TAG:-latest}` |
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/research-hub` |
| Venv | `/home/devuser/github/research-hub/.venv/bin/python` |
| DB (lokal) | `localhost:5432/research_hub` |
