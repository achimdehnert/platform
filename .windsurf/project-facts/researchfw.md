# Project Facts: researchfw

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/researchfw.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py researchfw`
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/researchfw` |
| Python | `/home/devuser/github/researchfw/.venv/bin/python` |
