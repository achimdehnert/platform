...
> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/risk-hub.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py risk-hub`
...
| **Image** | `ghcr.io/achimdehnert/risk-hub-web:${IMAGE_TAG:-latest}` |
