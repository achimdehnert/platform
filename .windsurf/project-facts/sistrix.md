# Project Facts: sistrix

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/sistrix.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py sistrix`

---

## Projekt

- **Beschreibung**: toolsset auf basis sistrx
- **GitHub**: `achimdehnert/sistrix` → https://github.com/achimdehnert/sistrix
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/sistrix` |
| Python | `/home/devuser/github/sistrix/.venv/bin/python` |
