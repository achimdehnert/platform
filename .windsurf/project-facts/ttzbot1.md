# Project Facts: ttzbot1

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/ttzbot1.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py ttzbot1`
...
- **Beschreibung**: –
- **GitHub**: `achimdehnert/ttzbot1` → https://github.com/achimdehnert/ttzbot1
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/ttzbot1` |
| Python | `/home/devuser/github/ttzbot1/.venv/bin/python` |
