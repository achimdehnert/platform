# Project Facts: weltenfw

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/weltenfw.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py weltenfw`
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/weltenfw` |
| Python | `/home/devuser/github/weltenfw/.venv/bin/python` |
