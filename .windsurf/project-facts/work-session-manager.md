# Project Facts: work-session-manager

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/work-session-manager.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py work-session-manager`
...
- **Beschreibung**: –
- **GitHub**: `achimdehnert/work-session-manager` → https://github.com/achimdehnert/work-session-manager
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/work-session-manager` |
| Python | `/home/devuser/github/work-session-manager/.venv/bin/python` |
