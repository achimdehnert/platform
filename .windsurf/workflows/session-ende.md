...
| 23 | Ab `full`-Footprint: Abnahme (0d) und Clear-Härte (0e) von je einem Subagenten mit fremdem Kontext gegengelesen, Ergebnis im Stand-Block — oder `lean` begründet bzw. Regel-1-Bruch benannt (Phase 0h) | ☐ |
...
- 2026-09-02: **Phase 0f-verankerung (PFLICHT) + Checklisten-Zeile 23** — platform#2690 K4.
...
- 2026-08-17: **Phase 0h Fremder Blick (PFLICHT ab `full`) + Checklisten-Zeile 23** —
  ...
  **Nachtrag 2026-09-02 beim Nachziehen auf `main`:** diese Phase hiess im Zweig 0g. Waehrend der Zweig lag, vergab `main` denselben Buchstaben an eine andere Pflicht-Phase (Zusagen gegen Tracking-Artefakte, platform#2211) — die gemergte, anderswo referenzierte Identitaet behaelt ihren Namen, diese hier wurde zu **0h**, Checklisten-Zeile 19 -> 22.
