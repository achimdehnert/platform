...
**Nebenbei erledigt:** zwei Scan-Hänger geklärt (BMW-Konfiguration = Paperless 2499, Stapel 2429 ins Archiv) · netcup antwortet mit fremdem Host-Key, Sachstand in [#2950](https://github.com/achimdehnert/platform/issues/2950) · Ersatz-Runner `mcp-hub-staging-ci` auf dev-desktop (Owner führte das Runbook aus), Deklaration [#3028](https://github.com/achimdehnert/platform/pull/3028).
