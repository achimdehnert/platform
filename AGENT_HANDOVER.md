...
**Sitzung 6972fc (robo-lab Exo-MVP-1, 2026-09-06/07):** nach [`AGENT_HANDOVER_ARCHIVE.md`](AGENT_HANDOVER_ARCHIVE.md) ausgelagert (2026-09-08); Offenes als Faden 46/47.

**Sitzung 61952dd7 (2026-09-08, Scan-Strecke):** Aus der Owner-Frage nach acht Seiten in einem Dokument wurde ein Melder: ein Scan, der im Consume-Baum liegen bleibt, und einer, der daraus verschwindet, ohne ein Dokument zu werden, melden sich jetzt selbst ([#2966](https://github.com/achimdehnert/platform/pull/2966), [#2970](https://github.com/achimdehnert/platform/pull/2970); stuendlich auf dem prod-Runner, Alarm als zugewiesenes Issue). Anlass war ein realer Verlust ([doc-hub#3](https://github.com/achimdehnert/doc-hub/issues/3)). **Eigener Fehler:** auf einer Memory-Notiz (ScanSnap liefere per SFTP) einen sshd-Eingriff aufgebaut, der wirkungslos blieb - der Lieferweg ist Samba (592 Logzeilen, alle `smbd:`); Notiz korrigiert, Eingriff zurueckgenommen. Dazu `/scan` als Kommando ([#2971](https://github.com/achimdehnert/platform/pull/2971)). **Offen:** Samba-Schreibprotokoll vorbereitet, Ausfuehrung Owner (doc-hub#3).
