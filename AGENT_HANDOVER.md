...
4. `PYPI_API_TOKEN` in platform löschen (Owner-Klick, kein Konsument, OIDC-only); iil-enrichment auf PyPI, gaeb-toolkit per Fleet-Report #968 (#2380 zu): https://github.com/achimdehnert/platform/issues/3327
