...
5. **Review-Durchsatz:** offene platform-PRs sind CI-grün und warten auf den 2.-Owner-Review, 0 rote PRs. 2. Owner (`wirdigital`) baut den Stau aktiv ab. → [PR-Liste](https://github.com/achimdehnert/platform/pulls)
...
> **Erledigt 2026-07-21 (Parallel-Session, nicht diese):** [#1288](https://github.com/achimdehnert/platform/pull/1288) GEMERGT — ADR-072 + ADR-158 entstalt („lügender Index" aus #1167 damit erledigt) · [#1284](https://github.com/achimdehnert/platform/pull/1284) GEMERGT (Handover-Stand 07-20/21).
