...
1. **[#1953](https://github.com/achimdehnert/platform/issues/1953) — zwei blinde Cron-Melder, einer davon still tödlich.** `Gen project-facts.md` scheitert bei **jedem geplanten Lauf** (6× in Folge seit 06.07.), während manuelle Läufe grün sind — auf Zuruf gesund, im Plan tot. Folge: die 91 `project-facts.md` werden seit über fünf Wochen nicht mehr regeneriert, ohne dass irgendwo etwas rot aussieht. Zweiter Melder: `ADR-265 REC-3 Sync-Drift Meter`, dauerhaft rot, dessen Ausgang echte Flotten-Drift nicht von einem Aufruffehler trennt.
