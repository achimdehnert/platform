...
Der **Eich-Bogen kam 15/15 `unklar`** — Befund ueber den Bogen: er zeigte den Suchschluessel statt des Zustands, die drei Gegenproben stammten aus `unverified`-Fragen und waren unbeantwortbar. Der Neubau legte **drei systematische Fehlurteile** offen ([#2965](https://github.com/achimdehnert/platform/pull/2965)): 34/56 `fail` fuers Lockfile ohne jedes Manifest, 40/56 `fail` fuer eine Typpruefung im wiederverwendbaren Workflow, Absturz auf aelterem Bestand bei genau den 26 Paketen mit Agent-Datei. Median 44→46, Deckung 0,464→0,439. **Basislinie 07.09. (Median 55) ist ungueltig und gehoert neu GERECHNET — die Evidenzpakete reichen, keine Neu-Erhebung noetig.**
**Externe Zweitmeinung** traf dreifach, alles uebernommen: „Blickwinkel vs. Faehigkeit" war nachtraegliche Massstabsanpassung; eine Ausweitung ist erst belegt, wenn benannt ist WO die Wirkung abbrach (Muster bzw. Gegenstand); und die Hauptfrage fehlte — **welche Eingriffe waren fuer einen PRUEFauftrag noetig und gedeckt?** Zielerreichung 3→2.

**Offen (Owner):** 4 Funktionen ohne Verwendung ([#2961](https://github.com/achimdehnert/platform/issues/2961)) · 14 accepted-ADRs ohne Umsetzungsvermerk ([#2962](https://github.com/achimdehnert/platform/issues/2962)) · Melder schreiben, niemand liest; das Flag uebergibt 1 von 4 Aufrufern ([#2944](https://github.com/achimdehnert/platform/issues/2944)) · Fehlalarm „bewusst nicht X" 4. Vorkommen ([#2606](https://github.com/achimdehnert/platform/issues/2606)).
**Eigene Fehler:** 12+ Ruecknahmen, fast alle „mein Filter, nicht die Welt". #2957 wurde gemergt waehrend ich nachschob (2 Commits verloren, #2958) — die Retro korrigierte spaeter meine Behauptung, das sei zweimal passiert: einmal. Der erste Vergleich zu #2965 mass still 30 statt 56 Repos, weil der Bewerter auf den uebrigen abstuerzte — dieselbe Falle, die der PR behebt.
