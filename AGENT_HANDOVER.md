...
**Sitzung 61952dd7 (2026-09-08, Scan-Strecke):** Aus der Owner-Frage nach acht Seiten in einem Dokument wurde ein Melder: ein Scan, der im Consume-Baum liegen bleibt, und einer, der daraus verschwindet, ohne ein Dokument zu werden, melden sich jetzt selbst ([#2966](https://github.com/achimdehnert/platform/pull/2966), [#2970](https://github.com/achimdehnert/platform/pull/2970)), dazu `/scan` ([#2971](https://github.com/achimdehnert/platform/pull/2971)). Anlass war ein realer Verlust ([doc-hub#3](https://github.com/achimdehnert/doc-hub/issues/3)). **Eigener Fehler:** auf einer Memory-Notiz (ScanSnap liefere per SFTP) einen sshd-Eingriff aufgebaut, der wirkungslos blieb - der Lieferweg ist Samba (592 Logzeilen, alle `smbd:`); Notiz korrigiert, Eingriff zurueckgenommen, Samba-Schreibprotokoll stattdessen aktiv. **Doppelarbeit:** #2972 lief parallel zu #2967 an derselben Datei - geschlossen, Befund in [#2974](https://github.com/achimdehnert/platform/issues/2974).
