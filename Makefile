...
.PHONY: help menu boards boards-check kette aufraeumen test lint betrieb-check setup windsurf-clean windsurf-status windsurf-force sevdesk-zahlungsabgleich
