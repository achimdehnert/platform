# Project Facts: TinyTroupe

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/TinyTroupe.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py TinyTroupe`

---

## Projekt

- **Beschreibung**: LLM-powered multiagent persona simulation for imagination enhancement and business insights.
- **GitHub**: `achimdehnert/TinyTroupe` → https://github.com/achimdehnert/TinyTroupe
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/TinyTroupe` |
| Python | `/home/devuser/github/TinyTroupe/.venv/bin/python` |
