# Project Facts: adpa-framework

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/adpa-framework.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py adpa-framework`
...
- **Beschreibung**: –
- **GitHub**: `achimdehnert/adpa-framework` → https://github.com/achimdehnert/adpa-framework
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/adpa-framework` |
| Python | `/home/devuser/github/adpa-framework/.venv/bin/python` |
