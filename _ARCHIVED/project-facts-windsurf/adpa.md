...
> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/adpa.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py adpa`
...
- **Beschreibung**: –
- **GitHub**: `achimdehnert/adpa` → https://github.com/achimdehnert/adpa
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/adpa` |
| Python | `/home/devuser/github/adpa/.venv/bin/python` |
