# Project Facts: authoringfw

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/authoringfw.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py authoringfw`
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/authoringfw` |
| Python | `/home/devuser/github/authoringfw/.venv/bin/python` |
