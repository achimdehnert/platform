# Project Facts: desktop-setup

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/desktop-setup.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py desktop-setup`

---

## Projekt

- **Beschreibung**: Windsurf + MCP Setup für neuen Ubuntu Desktop
- **GitHub**: `achimdehnert/desktop-setup` → https://github.com/achimdehnert/desktop-setup
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/desktop-setup` |
| Python | `/home/devuser/github/desktop-setup/.venv/bin/python` |
