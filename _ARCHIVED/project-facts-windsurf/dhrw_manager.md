# Project Facts: dhrw_manager

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/dhrw_manager.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py dhrw_manager`

---

## Projekt

- **Beschreibung**: Managemen von Belangen des Brandschutzes 
- **GitHub**: `achimdehnert/dhrw_manager` → https://github.com/achimdehnert/dhrw_manager
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/dhrw_manager` |
| Python | `/home/devuser/github/dhrw_manager/.venv/bin/python` |
