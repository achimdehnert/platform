# Project Facts: groupcases

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/groupcases.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py groupcases`
...
- **Beschreibung**: –
- **GitHub**: `achimdehnert/groupcases` → https://github.com/achimdehnert/groupcases
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/groupcases` |
| Python | `/home/devuser/github/groupcases/.venv/bin/python` |
