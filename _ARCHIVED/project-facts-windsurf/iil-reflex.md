...
> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/iil-reflex.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py iil-reflex`
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/iil-reflex` |
| Python | `/home/devuser/github/iil-reflex/.venv/bin/python` |
