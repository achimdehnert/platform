...
> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/iil-relaunch.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py iil-relaunch`
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/iil-relaunch` |
| Python | `/home/devuser/github/iil-relaunch/.venv/bin/python` |
