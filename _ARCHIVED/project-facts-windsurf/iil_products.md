# Project Facts: iil_products

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/iil_products.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py iil_products`

---

## Projekt

- **Beschreibung**: prototypen von iil-projekten
- **GitHub**: `achimdehnert/iil_products` → https://github.com/achimdehnert/iil_products
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/iil_products` |
| Python | `/home/devuser/github/iil_products/.venv/bin/python` |
