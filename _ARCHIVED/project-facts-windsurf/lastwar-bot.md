# Project Facts: lastwar-bot

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/lastwar-bot.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py lastwar-bot`
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/lastwar-bot` |
| Python | `/home/devuser/github/lastwar-bot/.venv/bin/python` |
