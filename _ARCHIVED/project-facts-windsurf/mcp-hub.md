# Project Facts: mcp-hub

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/mcp-hub.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py mcp-hub`
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/mcp-hub` |
