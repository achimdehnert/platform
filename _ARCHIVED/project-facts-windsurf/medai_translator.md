# Project Facts: medai_translator

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/medai_translator.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py medai_translator`

---

## Projekt

- **Beschreibung**: ppt translator
- **GitHub**: `achimdehnert/medai_translator` → https://github.com/achimdehnert/medai_translator
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/medai_translator` |
| Python | `/home/devuser/github/medai_translator/.venv/bin/python` |
