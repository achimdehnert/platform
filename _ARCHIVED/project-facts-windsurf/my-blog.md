# Project Facts: my-blog

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/my-blog.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py my-blog`
...
- **Beschreibung**: –
- **GitHub**: `achimdehnert/my-blog` → https://github.com/achimdehnert/my-blog
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/my-blog` |
| Python | `/home/devuser/github/my-blog/.venv/bin/python` |
