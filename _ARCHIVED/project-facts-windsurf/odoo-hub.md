# Project Facts: odoo-hub

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/odoo-hub.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py odoo-hub`
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/odoo-hub` |
| Python | `/home/devuser/github/odoo-hub/.venv/bin/python` |
