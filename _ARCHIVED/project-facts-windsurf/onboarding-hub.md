# Project Facts: onboarding-hub

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/onboarding-hub.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py onboarding-hub`
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/onboarding-hub` |
| Python | `/home/devuser/github/onboarding-hub/.venv/bin/python` |
