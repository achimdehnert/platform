# Project Facts: php-apocenna

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/php-apocenna.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py php-apocenna`
...
- **Beschreibung**: –
- **GitHub**: `achimdehnert/php-apocenna` → https://github.com/achimdehnert/php-apocenna
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/php-apocenna` |
| Python | `/home/devuser/github/php-apocenna/.venv/bin/python` |
