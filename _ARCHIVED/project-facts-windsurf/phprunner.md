# Project Facts: phprunner

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/phprunner.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py phprunner`
...
- **Beschreibung**: –
- **GitHub**: `achimdehnert/phprunner` → https://github.com/achimdehnert/phprunner
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/phprunner` |
| Python | `/home/devuser/github/phprunner/.venv/bin/python` |
