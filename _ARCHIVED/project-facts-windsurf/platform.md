...
> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/platform.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py platform`
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/platform` |
| Python | `/home/devuser/github/platform/.venv/bin/python` |
