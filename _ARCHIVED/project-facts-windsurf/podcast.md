# Project Facts: podcast

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/podcast.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py podcast`

---

## Projekt

- **Beschreibung**: podcastgen mit stimmen 
- **GitHub**: `achimdehnert/podcast` → https://github.com/achimdehnert/podcast
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/podcast` |
| Python | `/home/devuser/github/podcast/.venv/bin/python` |
