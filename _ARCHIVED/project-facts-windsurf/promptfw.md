# Project Facts: promptfw

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/promptfw.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py promptfw`
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/promptfw` |
| Python | `/home/devuser/github/promptfw/.venv/bin/python` |
