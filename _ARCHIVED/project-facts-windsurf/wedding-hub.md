# Project Facts: wedding-hub

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/wedding-hub.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py wedding-hub`

---

## Projekt

- **Beschreibung**: Wedding planning platform
- **GitHub**: `achimdehnert/wedding-hub` → https://github.com/achimdehnert/wedding-hub
- **Typ**: Django · Lifecycle: experimental
- **URL**: –
- **Staging**: `staging-wedding.iil.pet`
...
| **Pfad** | `/opt/wedding-hub` |
| **Port** | `8093` |
| **Container** | `wedding_hub_web` |
| **Migrate** | `python manage.py migrate --noinput` |
| **Compose** | `docker-compose.prod.yml` |
| **Image** | `ghcr.io/achimdehnert/wedding-hub-web:${IMAGE_TAG:-latest}` |
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/wedding-hub` |
| Venv | `/home/devuser/github/wedding-hub/.venv/bin/python` |
| DB (lokal) | `localhost:5432/wedding_hub` |
