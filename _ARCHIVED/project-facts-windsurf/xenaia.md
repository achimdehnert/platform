# Project Facts: xenaia

> ⚠️ AUTO-GENERATED — Nur in `platform/.windsurf/project-facts/xenaia.md` editieren!
> Neu generieren: `python3 platform/scripts/generate_project_facts.py xenaia`

---

## Projekt

- **Beschreibung**: zentral hub of my new projects 
- **GitHub**: `achimdehnert/xenaia` → https://github.com/achimdehnert/xenaia
...
| Variable | Wert |
|----------|------|
| Lokaler Pfad | `/home/devuser/github/xenaia` |
| Python | `/home/devuser/github/xenaia/.venv/bin/python` |
