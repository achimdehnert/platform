#!/usr/bin/env python
"""Create link_domain_phases.py management command"""
import os
from pathlib import Path

# Target file path
target_dir = Path('apps/bfagent/management/commands')
target_file = target_dir / 'link_domain_phases.py'
...
print('\n🚀 Run: python manage.py link_domain_phases')