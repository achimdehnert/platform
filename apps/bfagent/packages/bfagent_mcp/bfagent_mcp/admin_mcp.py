...
# =============================================================================
# DOMAIN ADMIN (Disabled - Domain model not in bfagent_mcp)
# =============================================================================
...
# Use MCPFileChange instead of MCPSessionFileChange
@admin.register(MCPFileChange)
class MCPFileChangeAdmin(admin.ModelAdmin):
    list_display = ['session', 'file_path', 'change_type', 'lines_added', 'lines_removed']
    list_filter = ['change_type']
    search_fields = ['file_path', 'session__id']
    readonly_fields = ['session', 'file_path', 'change_type', 'old_path', 'lines_added', 'lines_removed', 'diff_preview']


@admin.register(MCPConfigHistory)
class MCPConfigHistoryAdmin(admin.ModelAdmin):
    list_display = ['config', 'changed_field', 'old_value_display', 'new_value_display', 'changed_by', 'created_at']
    list_filter = ['changed_field', 'created_at']
    search_fields = ['config__domain__domain_id', 'changed_by__username']
    readonly_fields = ['config', 'changed_field', 'old_value', 'new_value', 'changed_by', 'created_at']
...
# =============================================================================
# REFACTORING RULES ADMIN (Disabled - Model not yet implemented)
# =============================================================================
...
# Conditional registration for TableNamingConvention
if HAS_NAMING_CONVENTIONS:
