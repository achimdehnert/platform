...
```
apps/control_center/
├── views_mcp.py              # Class-Based Views mit Mixins
├── urls_mcp.py               # URL Patterns (inkl. in urls.py)
├── tasks_mcp.py              # Celery Tasks
├── templates/control_center/mcp/
│   ├── dashboard.html        # Main Dashboard
│   ├── domain_list.html      # Domain Liste
│   ├── domain_detail.html    # Domain Detail
│   ├── sessions.html         # Sessions Liste
...
│       ├── session_row_content.html  # Single Row
│       └── toast.html            # Toast Template
└── static/control_center/mcp/
    ├── dashboard.css         # Styles
    └── dashboard.js          # HTMX Helpers
```
