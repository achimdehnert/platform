...
| Repository | Maintainer | Server-Owner | Verantwortlichkeit |
|------------|------------|--------------|-------------------|
| **platform** | Guild | — | CI/CD Workflows, Shared Packages, Docs, ADRs |
| **mcp-hub** | Guild | Per Server (siehe 4.1) | Repo-Struktur, mcp-core, CI/CD, PR-Routing |
| **bfagent** | Alpha | — | Product Repository |
| **travel-beat** | Bravo | — | Product Repository |
| **risk-hub** | Alpha | — | Product Repository |
| **cad-hub** | Alpha | — | Product Repository |
| **pptx-hub** | Bravo | — | Product Repository |

```
┌──────────────────────────────────────────────────────────────────────────┐
│                    MCP-HUB OWNERSHIP MODEL                               │
├──────────────────────────────────────────────────────────────────────────┤
│                                                                          │
│  📦 REPO-LEVEL (Guild Maintainer)                                       │
│  ═════════════════════════════════                                       │
│  • Repo-Struktur & Monorepo-Konventionen                                │
│  • Shared Code: mcp-core Library                                        │
│  • CI/CD: GitHub Actions für alle Server                                │
│  • PR-Review-Routing: Automatische Zuweisung an Server-Owner            │
│  • Dependency Management: Shared Dependencies                           │
│  • Release Coordination: Cross-Server Releases                          │
│                                                                          │
│  ────────────────────────────────────────────────────────────────────── │
│                                                                          │
│  📂 SERVER-LEVEL (Per MCP Server Owner)                                 │
│  ═══════════════════════════════════════                                 │
│  • Server-spezifischer Code (packages/<server>/)                        │
│  • Server-spezifische Tests                                             │
│  • Server-Dokumentation                                                 │
│  • Feature Development & Bug Fixes                                      │
│  • Quality Score (ADR-012)                                              │
│                                                                          │
│  ────────────────────────────────────────────────────────────────────── │
│                                                                          │
│  🔀 PR-ROUTING (CODEOWNERS)                                             │
│  ════════════════════════════                                            │
│                                                                          │
│  packages/llm_mcp/**        → @platform-guild                           │
│  packages/bfagent_mcp/**    → @team-alpha                               │
│  packages/travel_mcp/**     → @team-bravo                               │
│  packages/mcp-core/**       → @platform-guild                           │
│  .github/**                 → @platform-guild                           │
│  *                          → @platform-guild (fallback)                │
│                                                                          │
└──────────────────────────────────────────────────────────────────────────┘
```
