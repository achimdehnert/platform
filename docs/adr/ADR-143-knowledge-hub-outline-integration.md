...
| **Version-Pinning** | `outlinewiki/outline:0.82.0` — Update nur gezielt nach Test |
...
| Outline-Version pinnen? | Ja — `outlinewiki/outline:0.82.0` statt `:latest`. Update nur gezielt. | Entschieden |
