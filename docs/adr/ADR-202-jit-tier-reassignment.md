...
rejected-after: 4th-round advocatus-diaboli (concurrent with ADR-203). Five blocker-level issues identified before implementation. ADR-204 (Pre-Session Wizard) replaces the use-case at the right architectural layer.
---
