...
<!-- Last generated: 2026-08-24 · Next free ADR number: **298** -->

# Architecture Decision Records — Index

> **Next free ADR number:** 298  
> Auto-generated 2026-08-24 from ADR frontmatter — edit ADR files, not this file.
...
| 168 | Build Onboarding-Platform as separate repo on coach-hub primitives with billing-hub Stripe pattern | Void | ⬜ | [ADR-168](ADR-168-onboarding-platform-architecture.md) |
...
| 291 | Integrität der Steuerzone — Quellprüfung in CI, Laufzeitprüfung am Ort | Proposed | ⬜ | [ADR-291](ADR-291-freigabekern-gate.md) |
| 292 | Two-Lane-Deployment auf dem 6-Host-Bestand — Standard vor Speziallösung | Proposed | 🔶 | [ADR-292](ADR-292-two-lane-deployment-six-host-standard.md) |
