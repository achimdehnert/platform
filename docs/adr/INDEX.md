...
<!-- Last generated: 2026-07-21 · Next free ADR number: **282** -->

# Architecture Decision Records — Index

> **Next free ADR number:** 282  
> Auto-generated 2026-07-21 from ADR frontmatter — edit ADR files, not this file.
...
| 280 | Konsolidiere die Skill-Verteilung auf eine Lane — `skills/` wird einzige Kanonik, `commands`-Lane und `.windsurf`-Pfad werden zurückgebaut | Proposed | ⬜ | [ADR-280](ADR-280-skill-lane-consolidation.md) |
| 281 | Verteile Skills als Symlinks auf den Repo-Checkout statt als generierte Kopien | Proposed | ⬜ | [ADR-281](ADR-281-skill-distribution-symlink.md) |
