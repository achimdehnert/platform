...
| 256 | Migrate Orchestrator MCP transport from HTTP/SSE to stateless Streamable HTTP | Proposed | ⬜ | [ADR-256](ADR-256-orchestrator-mcp-stateless-streamable-http-transport.md) |
