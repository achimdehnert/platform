...
| 259 | Repo-scoped ADR-IDs — `<repo>:ADR-NNN` als kanonische Cross-Repo-Referenz (writing-hub Epic #11 / F22) | `Accepted` (2026-06-30, Rev 2) | ⬜ (Impl=Folge-Issue) | [ADR-259](ADR-259-repo-scoped-adr-ids.md) |
