...
| `tools/design_dna/mutate.py` (Claude API)        | ✅ Done       | 2026-03-27 | Mutation Engine                |
...
1. `mutate.py` mit Claude API
2. `design-mutate.yml` GitHub Action (manuell triggerable)
3. Mutation History in DNA-YAML

### Phase 4 — Hub-Integration (~4h)
1. Generierte CSS-Files pro Hub deployen
2. `base.html` pro Hub anpassen
