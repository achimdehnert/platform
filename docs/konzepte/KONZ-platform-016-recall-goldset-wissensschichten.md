...
| L10 | **Festlegung nach L9-Neubewertung (Owner, 2026-07-10):** Der L9-Kipppunkt hat nach Fix-Leiter Stufe 1+2 ([mcp-hub#168](https://github.com/achimdehnert/mcp-hub/pull/168) deployed) formal ausgelöst — Exakt-Pfad 4/4 Rang 1, NL-Fragen weiter 6/13 (echte Embedding-Schwäche). Neubewertungs-Ergebnis: **kein Graph, kein Umbau** — beide designten Konsumpfade sind gesund (Hook 100 %, ADR-209-Exakt-Pfad 4/4); die NL-Quote misst einen nicht-designten Pfad ohne realen Konsumenten. Erfolgskriterium der Schicht wechselt auf den Exakt-Pfad, NL läuft informativ weiter. **Wächter (falsifizierbar):** jeder reale Alltags-NL-Miss wird sofort Regressionsfrage; ≥ 3 reale Fälle/Quartal ⇒ Option 1 (Trigger-Wörter in Embedding-Input) wird ohne neue Diskussion gebaut. Optionen-Konserve in [#167](https://github.com/achimdehnert/mcp-hub/issues/167) (1 Embedding-Input · 2 Hybrid-Fulltext · 4 AGE-Graph zuletzt) | Entscheidung | Wiederholungslauf 2026-07-10, results.md 930be44 | gesetzt |
...
- 2026-07-10 (Abend): L10 — Festlegung nach L9-Auslösung (Exakt-Pfad bindend, NL informativ, Wächter ≥3 reale Fälle/Quartal); #167 geschlossen.
