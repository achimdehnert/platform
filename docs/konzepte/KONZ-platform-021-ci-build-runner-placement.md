...
evidence_manifest:
  ...
  - {claim_id: C11, source_path: "iilgmbh/shared-ci/.github/workflows/_ci-python.yml:556-600 (Job runner-label-check, ALLOWED_EXTRA=set(), parst nur job['runs-on'])", commit_or_pr: "main, Pfad nachgezogen 2026-07-25", opened_in_session: true}   # geöffnet durch Maintainer-2028-Subagent dieser Session; Original-Evidenz war platform/.github/workflows/_ci-python.yml:610-629, dort retired via #1437. Job-Block 2026-07-25 zeilenweise gegen die shared-ci-Fassung diffed: Label-Check-Logik identisch, einziger Unterschied sind die Action-Pins (checkout/setup-python v7 in der platform-Kopie, v6 in shared-ci) — die Aussage von C11 bleibt gültig
