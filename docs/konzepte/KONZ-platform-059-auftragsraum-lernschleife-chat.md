...
evidence_manifest:
  ...
  - {claim_id: C13, source_path: "iilgmbh/chat-hub#90", commit_or_pr: "iilgmbh/chat-hub#90 (OPEN, Owner-Wort 2026-09-14: Zusammenlegung Briefing/Mail/Aufträge → Achim / Lotse)", opened_in_session: true}
created: 2026-09-10
---
...
| D9 | **Zusammenlegung 2026-09-14** (chat-hub#90): die Räume „Briefing", „Mail" und „Aufträge Achim / Lotse" werden zu einem Raum „Achim / Lotse"; der Sortierer wird zum **Auffangnetz** über `tools/chat_agent/auftragsraum_sync.sh`, das dieselbe Geräte-/State-Dir-Kennung (`CHAT_LOTSE_STATE_DIR`, dasselbe `state["since"]`) wie die Raum-Wache verwendet — läuft die Wache, hält sie `sync.lock`, das Auffangnetz meldet „nichts nachzuholen" statt eines Fehlers; läuft keine Wache, holt es alles seit dem letzten Stand nach, nie doppelt. **Die Messgröße des Kill-Gates (2026-10-08) ist ab jetzt der zusammengelegte Raum**, nicht mehr die drei Einzelräume | Entscheidung | C13; Owner-Wort chat-hub#90 („80 Zusammenlegung ja … 82 freigabe") | entschieden |
