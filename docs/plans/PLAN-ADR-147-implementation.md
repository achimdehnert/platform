...
related-adr: ADR-147
origin: "Reklassifiziert von ADR-181 (2026-05-10, Schema v4 Migration)"
---
...
> **Hinweis**: Dieses Dokument wurde aus `docs/adr/ADR-181-implementation-plan.md` reklassifiziert.
> ADR-181 bleibt als `void` erhalten und verweist auf dieses Dokument.
