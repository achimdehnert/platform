...
| 21 | Betreff-Schlüssel des realen Vorgangs 189 („<Betreff-Schlüssel des Vorgangs 189, hier geschwärzt>") als Test-Fixture ins öffentliche Repo (#3042); Auftrag verbietet Betreffs ausdrücklich; ältere Fälle seit 2026-09-01 | Sicherheit / Konvention | mittel | SURVIVES (3b NEU-3) | test_mail_link_server.py:701,733; `git log -S` → 30cc4d62; #3015 K2/Out-of-Scope | – |
...
- Ob der Fixture-Schlüssel „<Betreff-Schlüssel des Vorgangs 189, hier geschwärzt>" wörtlich der Betreff ist — billigster Check (lokal, nicht im Repo): `grep -c '<Betreff-Schlüssel, geschwärzt>' ~/.claude/mail-vorgaenge.json`, nur die Zahl.
