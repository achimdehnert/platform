...
origin: "Reklassifiziert von ADR-182 (2026-05-10, Schema v4 Migration)"
---
...
> **Hinweis**: Dieses Dokument wurde aus `docs/adr/ADR-182-review.md` reklassifiziert.
> ADR-182 bleibt als `void` erhalten und verweist auf dieses Dokument.
...
Package liefert `AbstractConceptDocument` als Basis — Consumer erbt und fügt app-spezifische FKs hinzu.

**Empfehlung**: Phase A → Alternative A. Phase B+ → Alternative B für ausschreibungs-hub.
