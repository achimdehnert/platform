...
5. CHANGELOG in der Skill-Datei: nur die **letzten drei** Einträge, je ≤ 3 Zeilen; ältere Einträge wandern in die Begleitdoku `docs/governance/session-skills-lehren.md` (bzw. je Skill-Familie eine Lehren-Datei) — die Historie liegt in git. Ein Eintrag nennt Datum, Anlass (Issue/PR) und die eine Regel, die sich ändert. (Skill-Texte werden zur Laufzeit gelesen; 18 KB Historie in drei Session-Skills kosteten Kontext ohne Ausführungswert — #2690 K5, Messung 2026-09-02.)
...
- 2026-09-02 (Vorschlag, unratifiziert): **Review-Gate 5 gekürzt** — CHANGELOG in der Skill-Datei nur noch die letzten drei Einträge, ältere wandern nach `docs/governance/session-skills-lehren.md`. Anlass: #2690 K5 (Kontext-Diät der drei Session-Skills auf ≤ 60 KB) — 18 KB Changelog-Historie (14 % des Texts) machten das Ziel ohne diese Änderung unerreichbar (Zielwert läge bei 74 KB).
