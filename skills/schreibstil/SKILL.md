...
- 2026-09-01 · hnu · gestrichen: der ganze Absatz „Für die Unterlagen, die Ihnen vorliegen, heißt das: Der Auftragsverarbeitungsvertrag … Ihr Hinweis zu § 7 bleibt trotzdem einschlägig — er gilt gleichlautend für den Vertrag über den Betrieb der MEiKI-Komponenten, und ich ziehe ihn dort nach." · Grund: die Mail nimmt eine Pflicht zurück; ein zweiter Vorgang (Befund der Gegenseite an einem anderen Vertrag) im selben Text macht aus der Entlastung eine Aufgabenliste. Der fremde Befund gehört in die Antwort auf ihn, nicht in die Korrektur
- 2026-09-01 · hnu · gestrichen: „Die Herleitung über alle Projektphasen liegt als Anlage bei." · Grund: die Anlage hängt sichtbar an der Mail — ein Satz, der auf sie zeigt, sagt nichts, was der Empfänger nicht sieht
